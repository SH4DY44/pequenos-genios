    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-[var(--interactive-orange)]">
        ...
        <div className="space-y-6">
          ...
          <section className="bg-orange-50 p-6 rounded-lg">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <span className="text-2xl mr-3">🔔</span>
                <p><strong>¡Presiona el timbre cuando veas exactamente 5 frutas iguales!</strong></p>
              </li>
            </ul>
          </section>
          ...
          <section className="bg-yellow-50 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-lg">
                <h4 className="font-bold text-green-600 mb-2">Ejemplo Correcto:</h4>
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Hay exactamente 5 manzanas. ¡Debes presionar el timbre!
                </p>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Hay 3 manzanas y 2 plátanos. No hay 5 frutas iguales, ¡no debes presionar el timbre!
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-green-50 p-6 rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <p><strong>Frutas:</strong> {configNivel?.numFrutas || 3} tipos diferentes</p>
              <p><strong>Duración:</strong> {configNivel?.duracionJuego || 60} segundos</p>
          ...
          <section className="bg-blue-50 p-6 rounded-lg">
            <h3 className="text-lg font-bold mb-4 text-blue-800">Consejos:</h3>
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                <span className="text-xl mr-2">💡</span>
                <p>Presiona rápido cuando veas 5 frutas iguales, ¡pero no te precipites!</p>
              </li>
              <li className="flex items-start">
                <span className="text-xl mr-2">💡</span>
